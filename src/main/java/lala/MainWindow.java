...
public class MainWindow extends AnchorPane {
    ...
    private Image lalaImage = new Image(this.getClass().getResourceAsStream("/images/Lala.png"));
    ...
    /** Injects the Lala instance */
    public void setLala(Lala l) throws NoSuchCommandException, NoDescriptionException, IOException {
        lala = l;
        dialogContainer.getChildren().addAll(
                DialogBox.getLalaDialog(lala.run(), lalaImage)
        );
    }
